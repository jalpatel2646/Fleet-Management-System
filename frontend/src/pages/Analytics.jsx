...
const Analytics = () => {
    ...
    const loadAnalytics = async () => {
        ...
        try {
            ...
            const fuelExpenses = expenses.data.filter(e => e.type === 'Fuel').reduce((s, e) => s + e.amount, 0);
            const maintExpenses = expenses.data.filter(e => e.type === 'Maintenance').reduce((s, e) => s + e.amount, 0);
